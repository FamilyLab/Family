...
@end
@interface PullPsCollectionView : PSCollectionView<EGORefreshTableHeaderDelegate, LoadMoreTableFooterDelegate>{
...
/* Delegate */
@property (nonatomic, assign) IBOutlet id<PullPsCollectionViewDelegate> pullDelegate;
@end
