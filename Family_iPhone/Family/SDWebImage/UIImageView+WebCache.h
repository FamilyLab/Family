 ...
 * 	
 */
@interface UIImageView (WebCache) <SDWebImageManagerDelegate, MBProgressHUDDelegate>

//@property (nonatomic, retain) NSNumber *expectedLength;
...
- (void)setImageWithProgressViewWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder;//for progressview By Aevit

#pragma mark - By Aevit  因为懒得去改其他地方，所以再增加这个函数。。。
