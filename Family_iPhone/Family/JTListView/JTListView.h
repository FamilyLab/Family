...
typedef enum {
    ...
    JTListViewScrollPositionBottom = UITableViewScrollPositionBottom
...
@interface JTListViewController : BaseViewController <JTListViewDataSource, JTListViewDelegate>
