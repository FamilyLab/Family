...
- (void)setMaxMinZoomScalesForCurrentBounds {
    ...
    if (_photoImageView.image.size.width > DEVICE_SIZE.width) {//如果图片宽度大于320，imageview的宽度就自动缩放至320 By Aevit
        float fitScale = (float)DEVICE_SIZE.width / (float)_photoImageView.image.size.width;
