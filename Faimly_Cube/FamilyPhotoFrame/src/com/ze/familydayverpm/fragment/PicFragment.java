...
//        			params.height =  (int) ( imgArray.get(i).height * ( (float)PublicInfo.SCREEN_W / (float)imgArray.get(i).width ) );
        			params.height = PublicInfo.SCREEN_W;
        			params.width =  (int) ( imgArray.get(i).width * ( (float)PublicInfo.SCREEN_H / (float)imgArray.get(i).width ) );
...
//            	mTvTopic.setText(temp.equals("") ? "无标题" : temp);
            }
