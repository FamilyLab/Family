...
//            [self.avatarImage setImageWithURL:[NSURL URLWithString:self.data.headStr] placeholderImage:[UIImage imageNamed:@"head_70.png"]];
        ...
        if (self.data.userId) {
            ...
            [self.avatarImage whenTapped:^{
                [[NSNotificationCenter defaultCenter] postNotificationName:@"showFamilyCardView" object:self.data.userId];
